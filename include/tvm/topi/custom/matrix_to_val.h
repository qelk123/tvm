 ...
 * \file nn/bias_add.h
 */
#ifndef TVM_TOPI_CUSTOM_MATRIX_TO_VAL_H_
#define TVM_TOPI_CUSTOM_MATRIX_TO_VAL_H_
...
inline Schedule schedule_matrix_to_val(const Target& target, const Array<Tensor>& outs) {
