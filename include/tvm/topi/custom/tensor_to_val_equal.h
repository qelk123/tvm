 ...
 * \file nn/bias_add.h
 */
#ifndef TVM_TOPI_CUSTOM_TENSOR_TO_VAL_EQUAL_H_
#define TVM_TOPI_CUSTOM_TENSOR_TO_VAL_EQUAL_H_
...
inline Schedule schedule_tensor_to_val_equal(const Target& target, const Array<Tensor>& outs) {
