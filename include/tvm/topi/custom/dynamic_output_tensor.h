 ...
 * \file nn/bias_add.h
 */
#ifndef dynamic_output_tensor_h_
#define dynamic_output_tensor_h_
...
inline Schedule schedule_dynamic_output_tensor(const Target& target, const Array<Tensor>& outs) {
